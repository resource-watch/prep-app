    ...
    stage ('Build docker') {
      switch ("${env.BRANCH_NAME}") {
        ...
        case "develop":
          ...
          break
        case "preproduction":
          sh("docker -H :2375 build -t ${imageTag} --build-arg --build-arg apiUrl=https://preproduction.prepdata.org/api datasetEnv=production,preproduction --build-arg callbackUrl=https://preproduction.prepdata.org/auth .")
          break
        case "master":
