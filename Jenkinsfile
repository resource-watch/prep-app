    ...
    stage ('Build docker') {
      switch ("${env.BRANCH_NAME}") {
        ...
        case "develop":
          ...
          break
        case "master":
          sh("docker -H :2375 build -t ${imageTag} --build-arg datasetEnv=production --build-arg apiUrl=https://www.prepdata.org/api --build-arg MAPBOX_API_TOKEN=${env.PREP_MAPBOX_API_TOKEN} .")
