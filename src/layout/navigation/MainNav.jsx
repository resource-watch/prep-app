    ...
    return (
      <nav className="c-nav -main">
        <ul>
            ...
            {aboutActive && (
              <div className="submenu">
                <ul className="submenu-list">
                  <li>
                    <Link activeClassName="-current" to="/partners">
                      Partners
                    </Link>
                  </li>
                  <li>
                    <Link activeClassName="-current" to="/faqs">
                      FAQs
                    </Link>
                  </li>
                  <li>
          ...
          <li>
            <Link activeClassName="-current" to="/dashboards">
              Dashboards
            </Link>
          </li>
          <li>
            <Link activeClassName="-current" to="/stories">
              Stories
            </Link>
          </li>
          <li>
            <Link activeClassName="-current" to="/resources">
              Resources
            </Link>
          </li>
