...
import DemoSlider from './home/demo-slider/demo-slider-component';
        ...
        <div>
          <article className="demo-slider-slide">
            ...
            <div className="slide-content">
              ...
              <p>
                Discover and interact with climate, physical and socioeconomic data. Filter
        ...
        <div>
          <article className="demo-slider-slide">
            ...
            <div className="slide-content">
              ...
              <p>
                Dashboards are a collection of data and tools that users compile
        ...
        <div>
          <article className="demo-slider-slide">
            ...
            <div className="slide-content">
              ...
              <p>
                Find selected resources for understanding the impacts of climate
