...
const getFilterQuery = state => state.exploreEmbedPage.datasets.filterQuery;
const getFilters = state => state.exploreEmbedPage.datasetFilters.filters;
const getGraphs = state => state.exploreEmbedPage.datasetFilters.graphs;
