  ...
  render() {
    return (
      <div className="l-how-to">
        ...
        <Article grid="small-12">
          <h2>
            Resources to Help You Use PREPdata
          </h2>
          <div className="cards">
            <div className="row">
              <div className="column small-12 medium-4">
                <div className="c-card -border -border-neutral">
                  ...
                  <p>
                    Learn how PREPdata can help with climate adaptation and resilience planning.
                  </p>
                  <a href="https://youtu.be/AJzz9-76Bgk">
                    INTRODUCTION TO PREPDATA
                  </a>
                </div>
              </div>
              <div className="column small-12 medium-4">
                <div className="c-card -border -border-neutral">
                  ...
                  <p>
                    Discover climate, physical, and socioeconomic data.
                  </p>
                  <a href="https://youtu.be/7PmMh6DWCbA">
                    EXPLORE PREP’S DATA
                  </a>
                </div>
              </div>
              ...
              <div className="column small-12 medium-4">
                <div className="c-card -border -border-neutral">
                  ...
                  <p>
                    Upload your own data and create custom visualizations.
                  </p>
                  <span className="link-placeholder">
                    COMING SOON!
                  </span>
              ...
              <div className="column small-12 medium-4">
                <div className="c-card -border -border-neutral">
                  ...
                  <p>
                    Explore climate projections for your area of interest.
                  </p>
                  <span className="link-placeholder">
                    COMING SOON!
                  </span>
              ...
              <div className="column small-12 medium-4">
                <div className="c-card -border -border-neutral">
                  ...
                  <p>
                    Create a dashboard to track the climate resilience indicators you’re most interested in.
                  </p>
                  <span className="link-placeholder">
                    COMING SOON!
                  </span>
