...
const getFilterQuery = state => state.exploreExportPage.datasets.filterQuery;
const getFilters = state => state.exploreExportPage.datasetFilters.filters;
const getGraphs = state => state.exploreExportPage.datasetFilters.graphs;
