...
class ShareNexgddpgeeTooltip extends React.Component {
  constructor(props) {
    super(props);
...
ShareNexgddpgeeTooltip.propTypes = {
  open: PropTypes.bool,
...
ShareNexgddpgeeTooltip.defaultProps = {
  onClickCheckWidgets: () => {
...
const mapStateToProps = state => ({
  ...
  datasetSlug: state.nexgddptoolgee.dataset ? state.nexgddptoolgee.dataset.slug : null
});
...
export default connect(mapStateToProps, mapDispatchToProps)(ShareNexgddpgeeTooltip);
