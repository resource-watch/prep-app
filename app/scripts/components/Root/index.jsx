  ...
  componentDidMount() {
    ...
    if (this.props.location.pathname.indexOf('embed') === -1) {
      ...
      script.innerHTML = `window._urq = window._urq || [];
        ...
        'text/javascript'; ur.async = true; ur.src = ('https:' ==
        document.location.protocol ? 'https://cdn.userreport.com/userreport.js' :
        'http://cdn.userreport.com/userreport.js'); var s =
