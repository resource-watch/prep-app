      ...
      <article className="c-article">
        <div className="row align-center">
          <div className="column small-12 medium-8">
            ...
            <p>The next phase of the PREP platform will enable users to create personalized dashboards of climate risks that combine top-down data with local information. Upload your own data or pull in data from authoritative global sources, build a dashboard of indicators and interactive data-driven stories, and share with or learn from peers others.
            </p>
        ...
        <div className="c-article-module">
          <div className="row">
            <div className="column align-middle small-12 medium-6">
              ...
              <p>Search for climate-relevant data on the explorer or upload your own data. Query and combine with data from other sources, and visualize them in the same platform. See what data similar communities are using to build resilience around the world.
              </p>
      ...
      <article className="c-article">
        <div className="row align-center">
          <div className="column small-12 medium-8">
            ...
            <p>Would you like to develop a dashboard? Or share insights from your community?  Over the coming months we plan to work with communities around the globe to help them develop their own dashboards.</p>
            <p>We can only work with a few groups at this time. Let us know why you think you would be an ideal group to pilot the PREP Platform.</p>
