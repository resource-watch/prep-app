...
// Redux
import { setMarkerPosition } from 'actions/nexlocageetool';
import { getIndicatorId, getIndicatorUnitSignal } from 'selectors/nexlocageetool';
...
const mapStateToProps = state => ({
  ...
  chartDataLoaded: state.nexlocageetool.chart.loaded,
  chartData: state.nexlocageetool.chart.data,
  chartDataError: state.nexlocageetool.chart.error,
