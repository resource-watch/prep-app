...
function EthiopiaInsight() {
  return (
    <div className="">
      ...
      <article className="c-article">
        <div className="row align-center">
          <div className="column align-right small-12 medium-12">
      ...
      <article className="c-article">
        <div className="row align-center">
          <div className="column small-12 medium-8">
            ...
            <h3>Tigray, Ethiopia</h3>
            <IFrame src="https://prep.carto.com/u/prep-admin/viz/c7fc6dc6-4b08-4d23-ac0b-ff07144ad89a/embed_map" />
        ...
        <div className="row align-center">
          <div className="column small-12 medium-6">
            <VegaChart data={tigray} />
          </div>

          <div className="column small-12 medium-6">
            <VegaChart data={chirps} />
          </div>
        </div>
      </article>
      ...
      <article className="c-article">
        <div className="row align-center">
          <div className="column small-12 medium-8">
            ...
            <h3>Somali, Ethiopia</h3>
            <IFrame src="https://prep.carto.com/u/prep-admin/viz/5824b7fa-705a-11e6-bb05-0e3ebc282e83/embed_map" />
        ...
        <div className="row align-center">
          <div className="column small-12 medium-6">
            <VegaChart data={somaliSeasonal} />
          </div>

          <div className="column small-12 medium-6">
            <VegaChart data={tigraySeasonal} />
          </div>
        </div>
      </article>
      ...
      <article className="c-article">
        <div className="row align-center">
          <div className="column small-12 medium-8">
            ...
            <h3>High, Medium and Low terciles for forecasted 2016 grainsetting seasonal precipitation compared to 17-year historical data</h3>
            <IFrame src="https://prep.carto.com/u/prep-admin/viz/8e9860a4-7058-11e6-aa42-0e233c30368f/embed_map" />
