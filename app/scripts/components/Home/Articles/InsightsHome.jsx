    ...
    <div>
      <div className="row">
        <div className="column small-12 medium-8">
          ...
          <p>Our changing climate is accelerating the intensity and frequency of shocks and stresses facing communities across the globe. There is a growing recognition that even with aggressive reductions in greenhouse gas emissions, continued changes in the Earth’s climate are inevitable.</p>
        </div>
      </div>
      <div className="row">
