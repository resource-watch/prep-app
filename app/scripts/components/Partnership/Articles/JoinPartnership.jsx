...
function JoinPartnership() {
  return (
    <div>
      ...
      <p>To become a partner, please fill out this <a href="http://goo.gl/forms/sQeIudXzBYhxStWi1">form</a>
        expressing your entity’s interest in PREP, your intended workgroup,
      ...
      <a href="http://goo.gl/forms/sQeIudXzBYhxStWi1">Go to form</a>
    </div>
  );
}
