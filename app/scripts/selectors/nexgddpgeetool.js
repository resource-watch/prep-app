...
const mapMode = ({ nexgddptoolgee }) => nexgddptoolgee.mapMode;
const range1Selection = ({ nexgddptoolgee }) => nexgddptoolgee.range1.selection;
const range2Selection = ({ nexgddptoolgee }) => nexgddptoolgee.range2.selection;
const dataset = ({ nexgddptoolgee }) => nexgddptoolgee.dataset || null;
const layers = ({ nexgddptoolgee }) => (nexgddptoolgee.indicatorDataset ? nexgddptoolgee.indicatorDataset.layer : []);
