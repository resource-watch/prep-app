      ...
      layers.push(
        <div className="layer" key={`map-layer-${index}`}>
          ...
          <div className="actions">
            ...
            <span onClick={this.props.actionClick} className="icon">
              <svg width="11" height="11" viewBox="0 0 11 11"><title>icon-target</title><path d="M6 9.973A4.502 4.502 0 0 0 9.973 6H11V5H9.973A4.502 4.502 0 0 0 6 1.027V0H5v1.027A4.502 4.502 0 0 0 1.027 5H0v1h1.027A4.502 4.502 0 0 0 5 9.973V11h1V9.973zm0-1.008A3.502 3.502 0 0 0 8.965 6H7V5h1.965A3.502 3.502 0 0 0 6 2.035V4H5V2.035A3.502 3.502 0 0 0 2.035 5H4v1H2.035A3.502 3.502 0 0 0 5 8.965V7h1v1.965z" fillRule="evenodd"/></svg>
            </span>
            <span onClick={this.props.actionClick} className="icon">
              <svg width="9" height="10" viewBox="0 0 9 10"><title>icon-time</title><path d="M6 2h1V0H6v2zM2 2h1V0H2v2zm5 .001v2H6v-2H3v2H2v-2H0V10h9V2.001H7zM1 9h7V5H1v4z" fillRule="evenodd"/></svg>
            </span>
